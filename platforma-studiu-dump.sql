...
INSERT INTO `grup` VALUES (1,1,5,'2031-06-30 23:59:59'),(2,2,4,'2032-07-15 23:59:59'),(3,3,6,'2028-08-01 23:59:59'),(4,4,3,'2030-12-15 23:59:59');
...
INSERT INTO `grup_studenti` VALUES (4,2);
...
INSERT INTO `profesor` VALUES (20,10,20,'Matematica'),(21,15,25,'Informatica'),(22,20,30,'Fizica'),(29,10,20,'Fizica'),(37,1,10,'Filologie'),(44,0,4,'Matematica');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `delete_profesor` BEFORE DELETE ON `profesor` FOR EACH ROW begin  delete from activitate_profesor where activitate_profesor.profesor_id=OLD.id;   end */;;
DELIMITER ;
...
INSERT INTO `student` VALUES (1,1,100),(2,1,110),(3,2,90),(4,2,100),(5,3,80),(6,3,90),(7,4,100),(8,4,105),(9,3,100),(10,1,75),(11,2,105),(12,4,110),(13,1,120),(14,2,90),(15,3,40),(17,1,90),(18,2,80),(19,3,85),(41,1,10),(42,1,10),(43,0,1);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `delete_student` BEFORE DELETE ON `student` FOR EACH ROW BEGIN  DELETE FROM activitate_nota WHERE student_id = OLD.id;  DELETE FROM curs_student WHERE student_id = OLD.id;  delete from autentificare where autentificare.id=OLD.id;  delete from grup_studenti where grup_studenti.student_id=OLD.id;  END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `delete_autentificare` BEFORE DELETE ON `utilizator` FOR EACH ROW begin delete from autentificare where autentificare.id=OLD.id; end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
-- Dump completed on 2025-10-12  2:07:11
