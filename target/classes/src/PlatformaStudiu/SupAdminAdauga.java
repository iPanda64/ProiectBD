...
public class SupAdminAdauga extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        SuperAdminBackend p = new SuperAdminBackend(globalId);
    ...
    private void createPanel(SuperAdminBackend p,AnchorPane root, Stage primaryStage) {
        ...
        Image Admin = new Image(path + "NewAdmin.png");
        ImageView adminButton = new ImageView(Admin);
        setupButton(adminButton, 280.0, 110.0);
        adminButton.setFitWidth(130.0);
        adminButton.setFitHeight(130.0);
        ...
        root.getChildren().addAll(astaziButton, toateButton, adminButton);
    }

    private VBox userData(Utilizator p, SuperAdminBackend a, Stage primaryStage, AnchorPane root) {
        ...
        downloadButton.setOnMouseClicked(e -> {
            ...
            {
                a.addAdmin(cnpField.getText(),numeField.getText(),prenumeField.getText(),telField.getText(),emailField.getText(),ibanField.getText(),contractField.getText(),userField.getText(),passField.getText());
                SupAdminAdauga professorPage = new SupAdminAdauga();
                professorPage.start(primaryStage);
            }
        });
