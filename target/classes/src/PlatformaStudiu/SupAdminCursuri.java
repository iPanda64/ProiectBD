...
public class SupAdminCursuri extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String cssPath_profesorPane="src/PlatformaStudiu/invisible.css";
        java.io.File cssFile_profesorPane = new java.io.File(cssPath_profesorPane);
        try {
            profesorPane.getStylesheets().add(cssFile_profesorPane.toURI().toURL().toExternalForm());
        }catch (Exception e) {e.printStackTrace();}
        ...
        String cssPath_studentPane="src/PlatformaStudiu/invisible.css";
        java.io.File cssFile_studentPane = new java.io.File(cssPath_studentPane);
        try {
            studentPane.getStylesheets().add(cssFile_studentPane.toURI().toURL().toExternalForm());
        }catch (Exception e) {e.printStackTrace();}
    ...
    private ScrollPane profesorList(SuperAdminBackend s) {
    ...
    private ScrollPane studentList(SuperAdminBackend s) {
        VBox buttonList = new VBox(10);
        buttonList.setStyle("-fx-background-color: transparent; -fx-border-color: transparent;");
    ...
    private void activitySearch(SuperAdminBackend a,AnchorPane root, Stage primaryStage){
    ...
    private Button createElement(SuperAdminBackend s, String label1Text) {
    ...
    private ScrollPane activityList(SuperAdminBackend s, Stage primaryStage) {
        VBox buttonList = new VBox(10);
        buttonList.setStyle("-fx-background-color: transparent; -fx-border-color: transparent;");
    ...
    private Button createActivityButton(SuperAdminBackend s, String label1Text, int idAct) {
        Button button = new Button();
        button.setStyle("-fx-background-color: transparent; -fx-padding: 0;");
    ...
    private ScrollPane cursList(SuperAdminBackend a, AnchorPane root, Stage primaryStage) {
        VBox buttonList = new VBox(10);
        buttonList.setStyle("-fx-background-color: transparent; -fx-border-color: transparent;");
    ...
    private Button createCustomButton(SuperAdminBackend s, String label1Text, int idC, Stage primaryStage,AnchorPane root) {
        Button button = new Button();
        button.setStyle("-fx-background-color: transparent; -fx-padding: 0;");
        Font SatoshiLight = Font.loadFont(fontPath + "Satoshi-Light.otf", 30);
