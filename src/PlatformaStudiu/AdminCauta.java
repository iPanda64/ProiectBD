...
public class AdminCauta extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String cssPath_cursPane="src/PlatformaStudiu/invisible.css";
    ...
    private VBox userData(Utilizator p, AdminBackend a, Stage primaryStage) {
    ...
    private ScrollPane utilizatorList(AdminBackend s, AnchorPane root, Stage primaryStage) {
    ...
    private Button createCustomButton(AdminBackend p, String labelId, String nume, String prenume, Stage primaryStage) {
        AnchorPane root = new AnchorPane();
    ...
    private void searchBar(AnchorPane root, Stage primaryStage) {
        ...
        root.getChildren().addAll(searchButton,searchBar,mesajField,studentButton,profesorButton);
    }
